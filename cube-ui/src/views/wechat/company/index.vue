<template>
  <div class="app-container">
    ...
    <el-dialog title="积分详细" v-model="openPointsRecord" width="1000px" append-to-body>
      <el-select
...
export default {
  ...
  computed: {
    balanceAfter() {
      ...
      return (this.form.points || 0) + changeAmount;
    }
  },
  methods: {
    /** 查询用户列表 */
    ...
    handlePaginationChange(pagination) {
      if (!this.$el) return;
      this.queryPointForm.page = pagination.page;
      this.queryPointForm.limit = pagination.limit;
      this.getUserPointsRecord();
    },
