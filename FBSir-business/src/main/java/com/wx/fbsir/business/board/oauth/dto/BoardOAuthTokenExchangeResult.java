...
/** Raw tokens that may leave the internal boundary only after the runner commits. */
public final class BoardOAuthTokenExchangeResult {
    ...
    public BoardOAuthTokenExchangeResult(
    ...
    public String scopeCanonical() {
        return scopeCanonical;
    }
    ...
    public String toString() {
        return "BoardOAuthTokenExchangeResult[REDACTED]";
    }
}
