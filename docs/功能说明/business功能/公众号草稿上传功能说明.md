...
**代码位置：** `WxFbsir-common/src/main/java/com/wx/fbsir/common/utils/file/FileUploadUtils.java`
...
**代码位置：** `WxFbsir-admin/src/main/java/com/wx/fbsir/web/controller/common/CommonController.java`
...
**代码位置：** `WxFbsir-ui/src/views/system/user/profile/officeAccountConfig.vue`
...
**加密工具位置：** `WxFbsir-common/src/main/java/com/wx/fbsir/common/utils/AesEncryptUtils.java`
...
**代码位置：** `WxFbsir-ui/src/views/business/content/dailyassistant/index.vue`
...
**代码位置：** `WxFbsir-ui/src/api/business/content/dailyassistant/officeAccount.js`
...
**位置：** `WxFbsir-business/src/main/java/com/wx/fbsir/business/officialaccount/`
...
**位置：** `WxFbsir-business/src/main/resources/mapper/officialaccount/`
...
**位置：** `WxFbsir-common/src/main/java/com/wx/fbsir/common/utils/`
...
**位置：** `WxFbsir-admin/src/main/java/com/wx/fbsir/web/controller/common/`
