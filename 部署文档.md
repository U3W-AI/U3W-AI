...
文档更新日期：2026年1月12日 16：40 文档版本：1.1.9
...
如果需要使用文档解析功能，请参考 **[文档解析助手功能说明](./docs/功能说明/文档解析助手功能说明.md)** 进行详细配置，包括：
- TikaMcp工具包部署
- 文档解析工作流导入
- HTTP回调节点配置
- 智能体配置
...
**解决方案**：
文档解析助手的详细故障排查请参考 **[文档解析助手功能说明](./docs/功能说明/文档解析助手功能说明.md)** 中的常见问题部分。
