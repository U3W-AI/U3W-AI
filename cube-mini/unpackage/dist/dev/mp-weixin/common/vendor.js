...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"U3W-AI","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/pages.json ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
var appid = "__UNI__F7AADF2"; // 做应用隔离
...
/* 32 */
/*!*****************************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/pages.json?{"type":"style"} ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  "pages": {
    ...
    "pages/mine/index": {
      ...
      "navigationBarBackgroundColor": "#1ec57c"
    },
...
/* 36 */
/*!***********************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/config.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 37 */
/*!****************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/store/index.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _user = _interopRequireDefault(__webpack_require__(/*! @/store/modules/user */ 39));
var _getters = _interopRequireDefault(__webpack_require__(/*! ./getters */ 49));
...
/* 39 */
/*!***********************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/store/modules/user.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var user = {
  state: {
    ...
    corpId: _storage.default.get(_constant.default.corpId),
  ...
  mutations: {
    ...
    SET_ID: function SET_ID(state, openid) {
      state.openid = openid;
      _storage.default.set(_constant.default.openid, openid);
    },
    SET_CORPID: function SET_CORPID(state, corpId) {
      state.corpId = corpId;
      _storage.default.set(_constant.default.corpId, corpId);
    },
    ...
    SET_USERNAME: function SET_USERNAME(state, username) {
      ...
      _storage.default.set(_constant.default.username, username);
    },
  ...
  actions: {
    ...
    // 微信登录
    WxLogin: function WxLogin(_ref2, userInfo) {
      var commit = _ref2.commit;
      var code = userInfo.code;
      var encryptedIv = userInfo.encryptedIv;
      var encryptedData = userInfo.encryptedData;
      var nickName = userInfo.nickName;
      var avatar = userInfo.avatar;
      var appId = userInfo.appId;
      var appSecret = userInfo.appSecret;
      return new Promise(function (resolve, reject) {
        (0, _login.wxLogin)(code, encryptedIv, encryptedData, nickName, avatar, appId, appSecret).then(function (res) {
          (0, _auth.setToken)(res.token);
          commit('SET_TOKEN', res.token);
          resolve();
        }).catch(function (error) {
    ...
    // 企业微信登录
    QyWxLogin: function QyWxLogin(_ref3, userInfo) {
      var commit = _ref3.commit;
      var code = userInfo.code;
      var qwcode = userInfo.qwcode;
      var appId = userInfo.appId;
      var appSecret = userInfo.appSecret;
      return new Promise(function (resolve, reject) {
        (0, _login.qywxLogin)(code, qwcode, appId, appSecret).then(function (res) {
          (0, _auth.setToken)(res.token);
          commit('SET_TOKEN', res.token);
          resolve();
        }).catch(function (error) {
    ...
    GetInfo: function GetInfo(_ref4) {
      ...
      return new Promise(function (resolve, reject) {
        (0, _login.getInfo)().then(function (res) {
          var user = res.user;
          var avatar = user == null || user.avatar == "" || user.avatar == null ? __webpack_require__(/*! @/static/images/profile.jpg */ 48) : user.avatar;
    ...
    // 刷新企业ID
    RefreshCorpId: function RefreshCorpId(_ref6) {
      var commit = _ref6.commit,
        state = _ref6.state;
      return new Promise(function (resolve, reject) {
        (0, _login.refreshCorpId)().then(function (res) {
          var user = res.user;
          var avatar = user == null || user.avatar == "" || user.avatar == null ? __webpack_require__(/*! @/static/images/profile.jpg */ 48) : user.avatar;
          var username = user == null || user.userName == "" || user.userName == null ? "" : user.userName;
          var nickname = user == null || user.nickName == "" || user.nickName == null ? "" : user.nickName;
...
/* 40 */
/*!******************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/utils/storage.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = void 0;
var _constant = _interopRequireDefault(__webpack_require__(/*! ./constant */ 41));
// 存储变量名
var storageKey = 'storage_data';

// 存储节点变量名
var storageNodeKeys = [_constant.default.avatar, _constant.default.openid, _constant.default.corpId, _constant.default.userId, _constant.default.name, _constant.default.roles, _constant.default.permissions];
var storage = {
...
/* 41 */
/*!*******************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/utils/constant.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 42 */
/*!**************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/api/login.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.qywxLogin = qywxLogin;
exports.refreshCorpId = refreshCorpId;
...
// 微信登录方法
function wxLogin(code, encryptedIv, encryptedData, nickName, avatar, appId, appSecret) {
  var data = {
    code: code,
...
// 企业登录方法
function qywxLogin(code, qwcode, appId, appSecret) {
  var data = {
    code: code,
    qwcode: qwcode,
    appId: appId,
...
/* 43 */
/*!******************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/utils/request.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _config = _interopRequireDefault(__webpack_require__(/*! @/config */ 36));
var _log = _interopRequireDefault(__webpack_require__(/*! @/log */ 44));
var _auth = __webpack_require__(/*! @/utils/auth */ 45);
var _errorCode = _interopRequireDefault(__webpack_require__(/*! @/utils/errorCode */ 46));
var _common = __webpack_require__(/*! @/utils/common */ 47);
var timeout = 3000000;
var baseUrl = _config.default.baseUrl;
  ...
  return new Promise(function (resolve, reject) {
    uni.request({
      ...
      var _response = (0, _slicedToArray2.default)(response, 2),
        ...
        res = _response[1];
      if (error) {
        _log.default.error("请求参数：" + JSON.stringify(config) + "返回参数" + JSON.stringify(res));
        (0, _common.toast)('后端接口连接异常');
        reject('后端接口连接异常');
        return;
      }
      var code = res.data.code || 200;
      var msg = _errorCode.default[code] || res.data.msg || res.data.messages || _errorCode.default['default'];
      if (code === 401) {
        _log.default.error("请求参数：" + JSON.stringify(config) + "返回参数" + JSON.stringify(res));
...
/* 44 */
/*!********************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/log.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

/* WEBPACK VAR INJECTION */(function(wx) {var log = wx.getRealtimeLogManager ? wx.getRealtimeLogManager() : null;
module.exports = {
...
/* 45 */
/*!***************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/utils/auth.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 46 */
/*!********************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/utils/errorCode.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 47 */
/*!*****************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/utils/common.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 48 */
/*!***************************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/static/images/profile.jpg ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "static/images/profile.jpg";

/***/ }),
/* 49 */
/*!******************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/store/getters.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 53 */
/*!******************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/plugins/index.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = void 0;
var _tab = _interopRequireDefault(__webpack_require__(/*! ./tab */ 54));
var _auth = _interopRequireDefault(__webpack_require__(/*! ./auth */ 55));
var _modal = _interopRequireDefault(__webpack_require__(/*! ./modal */ 56));
var _default = {
...
/* 54 */
/*!****************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/plugins/tab.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 55 */
/*!*****************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/plugins/auth.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 56 */
/*!******************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/plugins/modal.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 57 */
/*!***************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/permission.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// 页面白名单
var whiteList = ['/pages/index', '/pages/mine/index', "/pages/login/index", "/pages/mine/about/index", '/pages/common/webview/index'];
...
/* 75 */
/*!***************************************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/node_modules/marked/lib/marked.umd.js ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

/* WEBPACK VAR INJECTION */(function(module) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__;var _toConsumableArray = __webpack_require__(/*! @babel/runtime/helpers/toConsumableArray */ 18);
var _classCallCheck = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ 23);
var _createClass = __webpack_require__(/*! @babel/runtime/helpers/createClass */ 24);
 ...
 */
(function (g, f) {
  if (( false ? undefined : _typeof(exports)) == "object" && ( false ? undefined : _typeof(module)) < "u") {
    module.exports = f();
  } else if (true) {
  ...
  var _notPunctuationOrSpace = /(?:(?![\t-\r -\/:-@\[-`\{-~\xA0-\xA9\xAB\xAC\xAE-\xB1\xB4\xB6-\xB8\xBB\xBF\xD7\xF7\u02C2-\u02C5\u02D2-\u02DF\u02E5-\u02EB\u02ED\u02EF-\u02FF\u0375\u037E\u0384\u0385\u0387\u03F6\u0482\u055A-\u055F\u0589\u058A\u058D-\u058F\u05BE\u05C0\u05C3\u05C6\u05F3\u05F4\u0606-\u060F\u061B\u061D-\u061F\u066A-\u066D\u06D4\u06DE\u06E9\u06FD\u06FE\u0700-\u070D\u07F6-\u07F9\u07FE\u07FF\u0830-\u083E\u085E\u0888\u0964\u0965\u0970\u09F2\u09F3\u09FA\u09FB\u09FD\u0A76\u0AF0\u0AF1\u0B70\u0BF3-\u0BFA\u0C77\u0C7F\u0C84\u0D4F\u0D79\u0DF4\u0E3F\u0E4F\u0E5A\u0E5B\u0F01-\u0F17\u0F1A-\u0F1F\u0F34\u0F36\u0F38\u0F3A-\u0F3D\u0F85\u0FBE-\u0FC5\u0FC7-\u0FCC\u0FCE-\u0FDA\u104A-\u104F\u109E\u109F\u10FB\u1360-\u1368\u1390-\u1399\u1400\u166D\u166E\u1680\u169B\u169C\u16EB-\u16ED\u1735\u1736\u17D4-\u17D6\u17D8-\u17DB\u1800-\u180A\u1940\u1944\u1945\u19DE-\u19FF\u1A1E\u1A1F\u1AA0-\u1AA6\u1AA8-\u1AAD\u1B5A-\u1B6A\u1B74-\u1B7E\u1BFC-\u1BFF\u1C3B-\u1C3F\u1C7E\u1C7F\u1CC0-\u1CC7\u1CD3\u1FBD\u1FBF-\u1FC1\u1FCD-\u1FCF\u1FDD-\u1FDF\u1FED-\u1FEF\u1FFD\u1FFE\u2000-\u200A\u2010-\u2029\u202F-\u205F\u207A-\u207E\u208A-\u208E\u20A0-\u20C0\u2100\u2101\u2103-\u2106\u2108\u2109\u2114\u2116-\u2118\u211E-\u2123\u2125\u2127\u2129\u212E\u213A\u213B\u2140-\u2144\u214A-\u214D\u214F\u218A\u218B\u2190-\u2426\u2440-\u244A\u249C-\u24E9\u2500-\u2775\u2794-\u2B73\u2B76-\u2B95\u2B97-\u2BFF\u2CE5-\u2CEA\u2CF9-\u2CFC\u2CFE\u2CFF\u2D70\u2E00-\u2E2E\u2E30-\u2E5D\u2E80-\u2E99\u2E9B-\u2EF3\u2F00-\u2FD5\u2FF0-\u2FFB\u3000-\u3004\u3008-\u3020\u3030\u3036\u3037\u303D-\u303F\u309B\u309C\u30A0\u30FB\u3190\u3191\u3196-\u319F\u31C0-\u31E3\u3200-\u321E\u322A-\u3247\u3250\u3260-\u327F\u328A-\u32B0\u32C0-\u33FF\u4DC0-\u4DFF\uA490-\uA4C6\uA4FE\uA4FF\uA60D-\uA60F\uA673\uA67E\uA6F2-\uA6F7\uA700-\uA716\uA720\uA721\uA789\uA78A\uA828-\uA82B\uA836-\uA839\uA874-\uA877\uA8CE\uA8CF\uA8F8-\uA8FA\uA8FC\uA92E\uA92F\uA95F\uA9C1-\uA9CD\uA9DE\uA9DF\uAA5C-\uAA5F\uAA77-\uAA79\uAADE\uAADF\uAAF0\uAAF1\uAB5B\uAB6A\uAB6B\uABEB\uFB29\uFBB2-\uFBC2\uFD3E-\uFD4F\uFDCF\uFDFC-\uFDFF\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE66\uFE68-\uFE6B\uFEFF\uFF01-\uFF0F\uFF1A-\uFF20\uFF3B-\uFF40\uFF5B-\uFF65\uFFE0-\uFFE6\uFFE8-\uFFEE\uFFFC\uFFFD]|\uD800[\uDD00-\uDD02\uDD37-\uDD3F\uDD79-\uDD89\uDD8C-\uDD8E\uDD90-\uDD9C\uDDA0\uDDD0-\uDDFC\uDF9F\uDFD0]|\uD801\uDD6F|\uD802[\uDC57\uDC77\uDC78\uDD1F\uDD3F\uDE50-\uDE58\uDE7F\uDEC8\uDEF0-\uDEF6\uDF39-\uDF3F\uDF99-\uDF9C]|\uD803[\uDEAD\uDF55-\uDF59\uDF86-\uDF89]|\uD804[\uDC47-\uDC4D\uDCBB\uDCBC\uDCBE-\uDCC1\uDD40-\uDD43\uDD74\uDD75\uDDC5-\uDDC8\uDDCD\uDDDB\uDDDD-\uDDDF\uDE38-\uDE3D\uDEA9]|\uD805[\uDC4B-\uDC4F\uDC5A\uDC5B\uDC5D\uDCC6\uDDC1-\uDDD7\uDE41-\uDE43\uDE60-\uDE6C\uDEB9\uDF3C-\uDF3F]|\uD806[\uDC3B\uDD44-\uDD46\uDDE2\uDE3F-\uDE46\uDE9A-\uDE9C\uDE9E-\uDEA2\uDF00-\uDF09]|\uD807[\uDC41-\uDC45\uDC70\uDC71\uDEF7\uDEF8\uDF43-\uDF4F\uDFD5-\uDFF1\uDFFF]|\uD809[\uDC70-\uDC74]|\uD80B[\uDFF1\uDFF2]|\uD81A[\uDE6E\uDE6F\uDEF5\uDF37-\uDF3F\uDF44\uDF45]|\uD81B[\uDE97-\uDE9A\uDFE2]|\uD82F[\uDC9C\uDC9F]|\uD833[\uDF50-\uDFC3]|\uD834[\uDC00-\uDCF5\uDD00-\uDD26\uDD29-\uDD64\uDD6A-\uDD6C\uDD83\uDD84\uDD8C-\uDDA9\uDDAE-\uDDEA\uDE00-\uDE41\uDE45\uDF00-\uDF56]|\uD835[\uDEC1\uDEDB\uDEFB\uDF15\uDF35\uDF4F\uDF6F\uDF89\uDFA9\uDFC3]|\uD836[\uDC00-\uDDFF\uDE37-\uDE3A\uDE6D-\uDE74\uDE76-\uDE83\uDE85-\uDE8B]|\uD838[\uDD4F\uDEFF]|\uD83A[\uDD5E\uDD5F]|\uD83B[\uDCAC\uDCB0\uDD2E\uDEF0\uDEF1]|\uD83C[\uDC00-\uDC2B\uDC30-\uDC93\uDCA0-\uDCAE\uDCB1-\uDCBF\uDCC1-\uDCCF\uDCD1-\uDCF5\uDD0D-\uDDAD\uDDE6-\uDE02\uDE10-\uDE3B\uDE40-\uDE48\uDE50\uDE51\uDE60-\uDE65\uDF00-\uDFFF]|\uD83D[\uDC00-\uDED7\uDEDC-\uDEEC\uDEF0-\uDEFC\uDF00-\uDF76\uDF7B-\uDFD9\uDFE0-\uDFEB\uDFF0]|\uD83E[\uDC00-\uDC0B\uDC10-\uDC47\uDC50-\uDC59\uDC60-\uDC87\uDC90-\uDCAD\uDCB0\uDCB1\uDD00-\uDE53\uDE60-\uDE6D\uDE70-\uDE7C\uDE80-\uDE88\uDE90-\uDEBD\uDEBF-\uDEC5\uDECE-\uDEDB\uDEE0-\uDEE8\uDEF0-\uDEF8\uDF00-\uDF92\uDF94-\uDFCA])[\s\S])/;
  ...
  var _notPunctuationOrSpaceGfmStrongEm = /(?:(?:(?![\t-\r -\/:-@\[-`\{-~\xA0-\xA9\xAB\xAC\xAE-\xB1\xB4\xB6-\xB8\xBB\xBF\xD7\xF7\u02C2-\u02C5\u02D2-\u02DF\u02E5-\u02EB\u02ED\u02EF-\u02FF\u0375\u037E\u0384\u0385\u0387\u03F6\u0482\u055A-\u055F\u0589\u058A\u058D-\u058F\u05BE\u05C0\u05C3\u05C6\u05F3\u05F4\u0606-\u060F\u061B\u061D-\u061F\u066A-\u066D\u06D4\u06DE\u06E9\u06FD\u06FE\u0700-\u070D\u07F6-\u07F9\u07FE\u07FF\u0830-\u083E\u085E\u0888\u0964\u0965\u0970\u09F2\u09F3\u09FA\u09FB\u09FD\u0A76\u0AF0\u0AF1\u0B70\u0BF3-\u0BFA\u0C77\u0C7F\u0C84\u0D4F\u0D79\u0DF4\u0E3F\u0E4F\u0E5A\u0E5B\u0F01-\u0F17\u0F1A-\u0F1F\u0F34\u0F36\u0F38\u0F3A-\u0F3D\u0F85\u0FBE-\u0FC5\u0FC7-\u0FCC\u0FCE-\u0FDA\u104A-\u104F\u109E\u109F\u10FB\u1360-\u1368\u1390-\u1399\u1400\u166D\u166E\u1680\u169B\u169C\u16EB-\u16ED\u1735\u1736\u17D4-\u17D6\u17D8-\u17DB\u1800-\u180A\u1940\u1944\u1945\u19DE-\u19FF\u1A1E\u1A1F\u1AA0-\u1AA6\u1AA8-\u1AAD\u1B5A-\u1B6A\u1B74-\u1B7E\u1BFC-\u1BFF\u1C3B-\u1C3F\u1C7E\u1C7F\u1CC0-\u1CC7\u1CD3\u1FBD\u1FBF-\u1FC1\u1FCD-\u1FCF\u1FDD-\u1FDF\u1FED-\u1FEF\u1FFD\u1FFE\u2000-\u200A\u2010-\u2029\u202F-\u205F\u207A-\u207E\u208A-\u208E\u20A0-\u20C0\u2100\u2101\u2103-\u2106\u2108\u2109\u2114\u2116-\u2118\u211E-\u2123\u2125\u2127\u2129\u212E\u213A\u213B\u2140-\u2144\u214A-\u214D\u214F\u218A\u218B\u2190-\u2426\u2440-\u244A\u249C-\u24E9\u2500-\u2775\u2794-\u2B73\u2B76-\u2B95\u2B97-\u2BFF\u2CE5-\u2CEA\u2CF9-\u2CFC\u2CFE\u2CFF\u2D70\u2E00-\u2E2E\u2E30-\u2E5D\u2E80-\u2E99\u2E9B-\u2EF3\u2F00-\u2FD5\u2FF0-\u2FFB\u3000-\u3004\u3008-\u3020\u3030\u3036\u3037\u303D-\u303F\u309B\u309C\u30A0\u30FB\u3190\u3191\u3196-\u319F\u31C0-\u31E3\u3200-\u321E\u322A-\u3247\u3250\u3260-\u327F\u328A-\u32B0\u32C0-\u33FF\u4DC0-\u4DFF\uA490-\uA4C6\uA4FE\uA4FF\uA60D-\uA60F\uA673\uA67E\uA6F2-\uA6F7\uA700-\uA716\uA720\uA721\uA789\uA78A\uA828-\uA82B\uA836-\uA839\uA874-\uA877\uA8CE\uA8CF\uA8F8-\uA8FA\uA8FC\uA92E\uA92F\uA95F\uA9C1-\uA9CD\uA9DE\uA9DF\uAA5C-\uAA5F\uAA77-\uAA79\uAADE\uAADF\uAAF0\uAAF1\uAB5B\uAB6A\uAB6B\uABEB\uFB29\uFBB2-\uFBC2\uFD3E-\uFD4F\uFDCF\uFDFC-\uFDFF\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE66\uFE68-\uFE6B\uFEFF\uFF01-\uFF0F\uFF1A-\uFF20\uFF3B-\uFF40\uFF5B-\uFF65\uFFE0-\uFFE6\uFFE8-\uFFEE\uFFFC\uFFFD]|\uD800[\uDD00-\uDD02\uDD37-\uDD3F\uDD79-\uDD89\uDD8C-\uDD8E\uDD90-\uDD9C\uDDA0\uDDD0-\uDDFC\uDF9F\uDFD0]|\uD801\uDD6F|\uD802[\uDC57\uDC77\uDC78\uDD1F\uDD3F\uDE50-\uDE58\uDE7F\uDEC8\uDEF0-\uDEF6\uDF39-\uDF3F\uDF99-\uDF9C]|\uD803[\uDEAD\uDF55-\uDF59\uDF86-\uDF89]|\uD804[\uDC47-\uDC4D\uDCBB\uDCBC\uDCBE-\uDCC1\uDD40-\uDD43\uDD74\uDD75\uDDC5-\uDDC8\uDDCD\uDDDB\uDDDD-\uDDDF\uDE38-\uDE3D\uDEA9]|\uD805[\uDC4B-\uDC4F\uDC5A\uDC5B\uDC5D\uDCC6\uDDC1-\uDDD7\uDE41-\uDE43\uDE60-\uDE6C\uDEB9\uDF3C-\uDF3F]|\uD806[\uDC3B\uDD44-\uDD46\uDDE2\uDE3F-\uDE46\uDE9A-\uDE9C\uDE9E-\uDEA2\uDF00-\uDF09]|\uD807[\uDC41-\uDC45\uDC70\uDC71\uDEF7\uDEF8\uDF43-\uDF4F\uDFD5-\uDFF1\uDFFF]|\uD809[\uDC70-\uDC74]|\uD80B[\uDFF1\uDFF2]|\uD81A[\uDE6E\uDE6F\uDEF5\uDF37-\uDF3F\uDF44\uDF45]|\uD81B[\uDE97-\uDE9A\uDFE2]|\uD82F[\uDC9C\uDC9F]|\uD833[\uDF50-\uDFC3]|\uD834[\uDC00-\uDCF5\uDD00-\uDD26\uDD29-\uDD64\uDD6A-\uDD6C\uDD83\uDD84\uDD8C-\uDDA9\uDDAE-\uDDEA\uDE00-\uDE41\uDE45\uDF00-\uDF56]|\uD835[\uDEC1\uDEDB\uDEFB\uDF15\uDF35\uDF4F\uDF6F\uDF89\uDFA9\uDFC3]|\uD836[\uDC00-\uDDFF\uDE37-\uDE3A\uDE6D-\uDE74\uDE76-\uDE83\uDE85-\uDE8B]|\uD838[\uDD4F\uDEFF]|\uD83A[\uDD5E\uDD5F]|\uD83B[\uDCAC\uDCB0\uDD2E\uDEF0\uDEF1]|\uD83C[\uDC00-\uDC2B\uDC30-\uDC93\uDCA0-\uDCAE\uDCB1-\uDCBF\uDCC1-\uDCCF\uDCD1-\uDCF5\uDD0D-\uDDAD\uDDE6-\uDE02\uDE10-\uDE3B\uDE40-\uDE48\uDE50\uDE51\uDE60-\uDE65\uDF00-\uDFFF]|\uD83D[\uDC00-\uDED7\uDEDC-\uDEEC\uDEF0-\uDEFC\uDF00-\uDF76\uDF7B-\uDFD9\uDFE0-\uDFEB\uDFF0]|\uD83E[\uDC00-\uDC0B\uDC10-\uDC47\uDC50-\uDC59\uDC60-\uDC87\uDC90-\uDCAD\uDCB0\uDCB1\uDD00-\uDE53\uDE60-\uDE6D\uDE70-\uDE7C\uDE80-\uDE88\uDE90-\uDEBD\uDEBF-\uDEC5\uDECE-\uDEDB\uDEE0-\uDEE8\uDEF0-\uDEF8\uDF00-\uDF92\uDF94-\uDFCA])[\s\S])|~)/;
  var blockSkip = /\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g;
    ...
    _createClass(__Lexer, [{
      ...
      value: function blockTokens(src) {
        ...
        var _loop2 = function _loop2() {
          var _this3$options$extens, _this3$options$extens2, _this3$options$extens3;
          var token = void 0;
          if ((_this3$options$extens = _this3.options.extensions) !== null && _this3$options$extens !== void 0 && (_this3$options$extens2 = _this3$options$extens.block) !== null && _this3$options$extens2 !== void 0 && _this3$options$extens2.some(function (extTokenizer) {
          ...
          var cutSrc = src;
          if ((_this3$options$extens3 = _this3.options.extensions) !== null && _this3$options$extens3 !== void 0 && _this3$options$extens3.startBlock) {
      ...
      value: function inlineTokens(src) {
        ...
        var _loop3 = function _loop3() {
          var _this4$options$extens, _this4$options$extens2, _this4$options$extens3;
          if (!keepPrevChar) {
            prevChar = "";
          }
          keepPrevChar = false;
          var token = void 0;
          if ((_this4$options$extens = _this4.options.extensions) !== null && _this4$options$extens !== void 0 && (_this4$options$extens2 = _this4$options$extens.inline) !== null && _this4$options$extens2 !== void 0 && _this4$options$extens2.some(function (extTokenizer) {
            if (token = extTokenizer.call({
              lexer: _this4
            }, src, tokens)) {
              src = src.substring(token.raw.length);
          ...
          var cutSrc = src;
          if ((_this4$options$extens3 = _this4.options.extensions) !== null && _this4$options$extens3 !== void 0 && _this4$options$extens3.startInline) {
            var startIndex = Infinity;
            var tempSrc = src.slice(1);
            var tempStart;
    ...
    _createClass(__Parser, [{
      ...
      function parse(tokens) {
        ...
        for (var i = 0; i < tokens.length; i++) {
          ...
          if ((_this$options$extensi = this.options.extensions) !== null && _this$options$extensi !== void 0 && (_this$options$extensi2 = _this$options$extensi.renderers) !== null && _this$options$extensi2 !== void 0 && _this$options$extensi2[anyToken.type]) {
      ...
      value: function parseInline(tokens) {
        ...
        for (var i = 0; i < tokens.length; i++) {
          ...
          var anyToken = tokens[i];
          if ((_this$options$extensi3 = this.options.extensions) !== null && _this$options$extensi3 !== void 0 && (_this$options$extensi4 = _this$options$extensi3.renderers) !== null && _this$options$extensi4 !== void 0 && _this$options$extensi4[anyToken.type]) {
  ...
  // src/Hooks.ts
  var _Hooks = (_class5 = /*#__PURE__*/function () {
    "use strict";
    ...
    return _Hooks;
  }(), _defineProperty(_class5, "passThroughHooks", /* @__PURE__ */new Set(["preprocess", "postprocess", "processAllTokens"])), _class5);
          ...
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
            ...
            switch (token.type) {
                    ...
                    for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
                      ...
                      try {
                        for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
                          ...
                          values = values.concat(this.walkTokens(_cell.tokens, callback));
                        }
                      } catch (err) {
                        _iterator7.e(err);
                      } finally {
              ...
              default:
                {
                  (function () {
                    var _this5$defaults$exten, _this5$defaults$exten2;
                    var genericToken = token;
                    if ((_this5$defaults$exten = _this5.defaults.extensions) !== null && _this5$defaults$exten !== void 0 && (_this5$defaults$exten2 = _this5$defaults$exten.childTokens) !== null && _this5$defaults$exten2 !== void 0 && _this5$defaults$exten2[genericToken.type]) {
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../../../../小红帽/HBuilderX.4.76.2025082103/HBuilderX/plugins/uniapp-cli/node_modules/webpack/buildin/module.js */ 76)(module)))
...
/* 77 */
/*!********************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/api/wechat/aigc.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.delBatchLink = delBatchLink;
exports.delLink = delLink;
exports.getAllScorePrompt = getAllScorePrompt;
exports.getChatHistory = getChatHistory;
exports.getChromeData = getChromeData;
exports.getChromeKeyWord = getChromeKeyWord;
exports.getHotKeyWordById = getHotKeyWordById;
exports.getHotKeyWordList = getHotKeyWordList;
exports.getHotKeyWordLog = getHotKeyWordLog;
exports.getMediaCallWord = getMediaCallWord;
exports.getNodeLog = getNodeLog;
exports.getPlayWrighDrafts = getPlayWrighDrafts;
exports.getScoreWord = getScoreWord;
exports.message = message;
exports.pushAutoOffice = pushAutoOffice;
exports.pushOffice = pushOffice;
exports.saveHotKeyWord = saveHotKeyWord;
exports.saveUserChatData = saveUserChatData;
exports.updateArticleLink = updateArticleLink;
exports.updateHotKeyWord = updateHotKeyWord;
exports.updateMediaCallWord = updateMediaCallWord;
var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request */ 43));
function getChromeData(query) {
  return (0, _request.default)({
...
function getHotKeyWordList(query) {
  return (0, _request.default)({
...
function getPlayWrighDrafts(query) {
  return (0, _request.default)({
...
function getChromeKeyWord(query) {
  return (0, _request.default)({
...
function getHotKeyWordLog(id) {
  return (0, _request.default)({
    url: '/aigc/getHotKeyWordLog?id=' + id,
    method: 'get'
  });
}
function getHotKeyWordById(id) {
  return (0, _request.default)({
    url: '/aigc/getHotKeyWordById?id=' + id,
    method: 'get'
  });
}
function pushOffice(ids) {
  return (0, _request.default)({
    url: '/mini/pushOffice',
    method: 'post',
    data: ids
...
function updateArticleLink(data) {
  return (0, _request.default)({
...
function saveUserChatData(data) {
  return (0, _request.default)({
...
function getChatHistory(userId, isAll) {
  return (0, _request.default)({
    url: '/aigc/getChatHistory?userId=' + userId + '&isAll=' + isAll,
    method: 'get'
  });
}
function pushAutoOffice(data) {
  return (0, _request.default)({
...
// 媒体相关API
function getMediaCallWord(platformId) {
  return (0, _request.default)({
    url: "/media/getCallWord/".concat(platformId),
    method: 'get'
  });
}
function updateMediaCallWord(platformId, wordContent) {
  return (0, _request.default)({
    url: "/media/updateCallWord/".concat(platformId),
    method: 'post',
    data: wordContent,
    headers: {
...
var v1 = __webpack_require__(/*! ./v1 */ 79);
var v4 = __webpack_require__(/*! ./v4 */ 82);
...
var rng = __webpack_require__(/*! ./lib/rng */ 80);
var bytesToUuid = __webpack_require__(/*! ./lib/bytesToUuid */ 81);
...
/* 83 */
/*!*****************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/utils/corpId.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.ensureCorpIdOnShow = ensureCorpIdOnShow;
exports.ensureLatestCorpId = ensureLatestCorpId;
exports.forceRefreshCorpId = forceRefreshCorpId;
exports.getCorpId = getCorpId;
exports.setCorpId = setCorpId;
var _store = _interopRequireDefault(__webpack_require__(/*! @/store */ 37));
var _storage = _interopRequireDefault(__webpack_require__(/*! @/utils/storage */ 40));
var _constant = _interopRequireDefault(__webpack_require__(/*! @/utils/constant */ 41));
// 企业ID最后刷新时间缓存
...
function updateLocalCorpId(corpId) {
  if (corpId) {
    ...
    _storage.default.set(_constant.default.corpId, corpId);
    // 更新Vuex store
    _store.default.commit('SET_CORPID', corpId);
...
function getLocalCorpId() {
  return _storage.default.get(_constant.default.corpId) || _store.default.state.user.corpId || '';
}
...
function ensureLatestCorpId() {
  ...
  if (forceRefresh || now - lastRefreshTime > REFRESH_INTERVAL) {
    return _store.default.dispatch('RefreshCorpId').then(function (res) {
      lastRefreshTime = now;
      var newCorpId = res.corpId;
      var currentCorpId = getLocalCorpId();
      ...
      if (newCorpId && newCorpId !== currentCorpId) {
        ...
        // 小程序端触发全局状态更新
        uni.$emit('corpIdUpdated', {
          corpId: newCorpId,
          oldCorpId: currentCorpId
        });
      }
      return res;
    }).catch(function (error) {
      ...
      // 即使刷新失败也返回当前的企业ID
      var cachedCorpId = getLocalCorpId();
 ...
 */
function getCorpId() {
  var autoRefresh = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
  if (autoRefresh) {
    return ensureLatestCorpId().then(function (res) {
      return res.corpId;
    });
  }
...
/* 92 */
/*!***************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/api/report.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.getUserPointsRecord = getUserPointsRecord;
exports.getUserPromptTem = getUserPromptTem;
exports.updateUserPromptTem = updateUserPromptTem;
var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request */ 43));
function getUserPointsRecord(data) {
  return (0, _request.default)({
...
//保存用户模板
function updateUserPromptTem(data) {
  return (0, _request.default)({
...
function getUserPromptTem(userId, agentId) {
  return (0, _request.default)({
...
/* 101 */
/*!********************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/api/system/user.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _upload = _interopRequireDefault(__webpack_require__(/*! @/utils/upload */ 102));
var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request */ 43));
// 用户密码重置
...
/* 102 */
/*!*****************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/utils/upload.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 142 */
/*!*****************************************************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/uni_modules/uni-icons/components/uni-icons/icons.js ***!
  \*****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 164 */
/*!********************************************************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/uni_modules/uni-forms/components/uni-forms/validate.js ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _inherits2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/inherits */ 28));
var _possibleConstructorReturn2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/possibleConstructorReturn */ 29));
var _getPrototypeOf2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ 31));
...
/* 165 */
/*!*****************************************************************************************!*\
  !*** D:/AAAi/U3W-AI-main/cube-mini/uni_modules/uni-forms/components/uni-forms/utils.js ***!
  \*****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
