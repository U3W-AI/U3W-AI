...
import com.cube.common.exception.user.*;
import com.cube.common.utils.DateUtils;
import com.cube.common.utils.MessageUtils;
import com.cube.common.utils.StringUtils;
import com.cube.common.utils.ip.IpUtils;
import com.cube.framework.manager.AsyncManager;
import com.cube.framework.manager.factory.AsyncFactory;
import com.cube.framework.security.context.AuthenticationContextHolder;
...
public class SysLoginService
{
    ...
    public String login(String username, String password, String code, String uuid)
    {
      ...
      //  validateCaptcha(username, code, uuid);
        ...
        redisCache.setCacheObject(loginUser.getUsername(),loginUser.getUser().getCorpId());
