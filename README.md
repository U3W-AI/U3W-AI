...
近日将进行较大幅度版本更新，会涉及部分AI的变动，请注意及时更新代码。

## 代码更新日志

- 2025-08-01：百家号在“投递到媒体”上架，目前的可投递媒体包括公众号和知乎、微头条、百家号。
- 2025-07-30：千问AI上架。目前可用的AI包括豆包、DeepSeek、MiniMax、千问。
- 2025-07-29：“投递到公众号”模块升级为“投递到媒体”。
...
与需要依赖官方API接口、需要向AI厂商支付API调用费用和Token费用的AI集成框架不同，U3W优立方AI主机的目标，是让大部分团队型创业者甚至中小企业，都有自己用得起的、与AI发展随时同步的AI主机，这一点，随着对于U3W优立方AI主机的了解和深入应用，再比较使用传统模式的AI主机和AI应用模式，用户会日益有感。
...
| 优立方 AI 主机执行层 | Java 17、Playwright                           | Windows 主机  | 驱动浏览器自动化执行 AI 任务（如调用DeepSeek、豆包等 AI 模型）；实时回传执行截图与日志；支持多账号并行运行。 |
